...
#Configure page: we want a wide not narrow layout as we need the space.
...
st.subheader("Chatbot: Ask a question about the different species from the below tables and graph")
