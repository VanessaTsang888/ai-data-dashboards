...
The objective of my interactive data dashboard website application is to visualise a range of different data types in the form of filtering tables and a scatter plot graph. My application is built with basic widgets, data panels, a live chatbot, AI-driven code-generation execution, and robust error feedback. All of this with python programming.
...
Scatter plot: this visualisation graph is very interactive. Click and drag the graph to pan in and out. To zoom in and to, use the scroll ball on your mouse. Hover your cursor over a plot to activate the tooltip feature. Each species is colour coded - see the Key on the right side of the graph.
